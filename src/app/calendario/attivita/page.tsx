...
export default function Attivita() {
  ...
  return (
    <div className="flex flex-col items-center gap-4 min-h-[92vh] bg-amber-600">
      <h1 className="pt-6 text-center text-4xl font-bold text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]" id="activity-header">
        Attività
      </h1>
  
      <div
        className="activities-container mx-2 mt-4 grid gap-2 justify-items-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4"
      ...
      <button
        ...
        aria-expanded={activityCreateModalOpen}
      >
        Aggiungi attività
      </button>
